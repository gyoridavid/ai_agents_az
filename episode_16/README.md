...
### Be part of a growing community and help us to create more content like this

## Free n8n JSON workflow

- [Workflow: create portait poem videos](workflow_poem_videos.json)
...
[![This $0 AI system creates TikTok videos on autopilot with n8n (free + open source)](https://img.youtube.com/vi/EbaErWRc7H4/0.jpg)](https://www.youtube.com/watch?v=EbaErWRc7H4)
